...
public class Button extends us.cubk.clickgui.component.Component {

    public Module module;
    public us.cubk.clickgui.component.Frame parent;
    public int offset;
    private boolean isHovered;
    private final ArrayList<us.cubk.clickgui.component.Component> subcomponents;
    public boolean open;

    public Button(Module mod, us.cubk.clickgui.component.Frame parent, int offset) {
        this.module = mod;
        this.parent = parent;
        this.offset = offset;
    ...
    public void setOff(int newOff) {
        offset = newOff;
        int opY = offset + 12;
        for (us.cubk.clickgui.component.Component comp : this.subcomponents) {
            comp.setOff(opY);
            opY += 12;
        }
    }
    ...
    public void renderComponent() {
        Gui.drawRect(parent.getX(), this.parent.getY() + this.offset, parent.getX() + parent.getWidth(), this.parent.getY() + 12 + this.offset, this.isHovered ? (module.enable ? new Color(0xFF222222).darker().getRGB() : 0xFF222222) : (module.enable ? new Color(14, 14, 14).getRGB() : 0xFF111111));
        GL11.glPushMatrix();
        String name;
        ...
        FontManager.hanYi(18).drawStringWithShadow(name, (parent.getX() + 2) , (parent.getY() + offset + 2)  , module.enable ? ClickGuiScreen.color : -1);
        if (this.subcomponents.size() > 2)
            FontManager.hanYi(18).drawStringWithShadow(this.open ? "-" : "+", (parent.getX() + parent.getWidth() - 10) , (parent.getY() + offset + 2)  , -1);
        GL11.glPopMatrix();
        if (this.open) {
