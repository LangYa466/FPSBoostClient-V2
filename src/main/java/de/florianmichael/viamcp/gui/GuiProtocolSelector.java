...
public class GuiProtocolSelector extends GuiScreen {
    ...
    @Override
    protected ResourceLocation actionPerformed(GuiButton guiButton) throws IOException {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        final int fixedHeight = ((5 + this.fontRendererObj.getHeight()) * 2) + 2;
        ...
        drawString(this.fontRendererObj, versionTitle, (width - this.fontRendererObj.getStringWidth(versionTitle)) / 2, fixedHeight + this.fontRendererObj.getHeight(), -1);
        drawString(this.fontRendererObj, versionReleased, (width - this.fontRendererObj.getStringWidth(versionReleased)) / 2, fixedHeight + this.fontRendererObj.getHeight() * 2, -1);
