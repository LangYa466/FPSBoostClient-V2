...
public class SprintDisplay extends Element {
    ...
    private final TextValue textFormatValue = new TextValue("文本格式","Text Format","Sprint: %s");

    @Override
    public void onDraw() {
        String text = String.format(textFormatValue.getValue(),Sprint.isEnable ? "Toggled" : "Vanilla");
