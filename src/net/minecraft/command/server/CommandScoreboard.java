...
public class CommandScoreboard extends CommandBase
{
            ...
            else
            {
                ...
                else if (args[0].equalsIgnoreCase("players"))
                {
                    ...
                    else if (args[1].equalsIgnoreCase("screenShotHelper"))
                    {
                        ...
                        {
                            throw new WrongUsageException("commands.scoreboard.players.screenShotHelper.usage");
                        }
    ...
    protected void func_175781_o(ICommandSender p_175781_1_, String[] p_175781_2_, int p_175781_3_) throws CommandException
    {
        ...
        else
        {
            ...
            {
                throw new CommandException("commands.scoreboard.players.screenShotHelper.notFound", scoreobjective.getName(), s);
            }
            else
            {
                ...
                {
                    notifyOperators(p_175781_1_, this, "commands.scoreboard.players.screenShotHelper.success", Integer.valueOf(score.getScorePoints()), Integer.valueOf(i), Integer.valueOf(j));
                }
                else
                {
                    throw new CommandException("commands.scoreboard.players.screenShotHelper.failed", Integer.valueOf(score.getScorePoints()), Integer.valueOf(i), Integer.valueOf(j));
                }
            }
        }
    }
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos)
    {
        ...
        else
        {
            ...
            else if (args[0].equalsIgnoreCase("players"))
            {
                if (args.length == 2)
                {
                    return getListOfStringsMatchingLastWord(args, "set", "add", "remove", "reset", "list", "enable", "screenShotHelper", "operation");
                }
