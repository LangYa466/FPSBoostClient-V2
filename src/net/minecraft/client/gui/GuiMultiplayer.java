...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
        this.buttonList.add(this.btnEditServer = new GuiButton(7, this.width / 2 - 154, this.height - 28, 74, 20, I18n.format("selectServer.edit")));
        this.buttonList.add(this.btnDeleteServer = new GuiButton(2, this.width / 2 - 76, this.height - 28, 74, 20, I18n.format("selectServer.delete")));
        ...
        this.buttonList.add(new GuiButton(8, this.width / 2 + 2, this.height - 28, 74, 20, I18n.format("selectServer.refresh")));
        this.buttonList.add(new GuiButton(0, this.width / 2 + 80, this.height - 28, 74, 20, I18n.format("gui.cancel")));
