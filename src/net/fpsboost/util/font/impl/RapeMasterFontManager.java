...
public class RapeMasterFontManager extends FontRenderer {
    ...
    public int drawStringWithShadow(String z, double x, double positionY, int mainTextColor) {
        return drawStringWithShadow(z, (float) x, (float) positionY, mainTextColor);
    }
