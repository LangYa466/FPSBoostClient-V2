...
public class CPSDisplay extends Element {
    ...
    private final TextValue textFormatValue = new TextValue("文本格式","Text Format","CPS : %s | %s");

    @Override
    public void onDraw() {
        String text = String.format(textFormatValue.getValue(), CpsUtil.getLeftCps(),CpsUtil.getRightCps());
